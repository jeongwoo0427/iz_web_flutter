...
class NavigationWidget extends StatefulWidget {
  ...
  const NavigationWidget({Key? key, this.showBackColor = false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
        ...
        decoration: BoxDecoration(
            color: widget.showBackColor ? colorScheme.primary : Colors.transparent,
            boxShadow: [BoxShadow(color: widget.showBackColor ? Colors.black.withOpacity(0.2) : Colors.transparent, offset: Offset(0, 2), blurRadius: 5)]),
          ...
          child: Row(
            ...
            children: [
              Text(
                'IZ web',
                style: TextStyle(
                    fontSize: 26, fontWeight: FontWeight.w500, color: widget.showBackColor ? colorScheme.onBackground : Colors.white.withOpacity(0.9)),
              ),
              ...
              Row(
                children: [
                  GestureDetector(
                    child: Text('넴플메이커',style: TextStyle(
